  ...
  (function($) {
    ...
    Sketch = (function() {
      ...
      function Sketch(el, opts) {
        ...
        this.background = this.options.backgroundColor;
        this.actions = [];
        this.action = [];
        this.undone = [];
        this.point = [];
      ...
      Sketch.prototype.operation = function(mode) {
        if (mode === "undo" && this.actions) {
          this.undone.push(this.actions.pop());
        } else if (mode === "redo" && this.undone) {
      ...
      Sketch.prototype.set = function(key, value) {
        this[key] = value;
        this.canvas.trigger("sketch.change" + key, value);
        if (key === "color") {
          this.set("tool", "marker");
        }
        if (key === "tool" && value === "line") {
    ...
    $.sketch.tools.eraser = {
      ...
      draw: function(action) {
        action.color = this.background;
        action.size = 10;
        return $.sketch.tools.marker.draw.call(this, action);
      }
    };
    return $.sketch.tools.line = {
      onEvent: function(e) {
        var newPoint;
        switch (e.type) {
          case 'mousedown':
